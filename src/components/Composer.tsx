...
export function Composer() {
  ...
  return (
    <div style={{ zIndex: LAYER.composer }}
      ...
      <AnimatePresence>
        {expanded && (
          ...
          >
            ...
            {answer && (
              <div className="mb-2.5 max-h-[62vh] overflow-y-auto rounded-[20px] p-[18px] shadow-[inset_0_0_0_1px_rgba(var(--rgb-iris),0.28)]" style={{ background: "linear-gradient(180deg,#1A1828 0%,#141221 100%)" }}>
                  ...
                  <div className="mt-3.5 flex flex-wrap items-center gap-1.5">
                    ...
                    {quellen.map((b) => (
                      <button
                        ...
                        className="rounded-pill px-2.5 py-1 font-body text-[11px] text-txt-2 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.13)] transition hover:text-txt hover:shadow-[inset_0_0_0_1px_rgba(var(--rgb-iris),0.42)]"
                      >
                        {b.label}
                      </button>
                    ))}
                    ...
                    <div className="flex flex-col gap-1.5">
                      {weiter.map((s) => (
                        <button
                          key={s.q}
                          onClick={() => frage(s)}
                          className="rounded-[14px] px-3 py-2.5 text-left font-body text-[13px] leading-snug text-txt-2 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.13)] transition hover:text-txt hover:shadow-[inset_0_0_0_1px_rgba(var(--rgb-iris),0.34)]"
                        >
                          {s.q}
              ...
              <div className="flex flex-col gap-1.5 pb-1">
                {vorschlaege.map((s) => (
                  <button
                    key={s.q}
                    onClick={() => frage(s)}
                    className="rounded-[16px] bg-[rgba(22,22,31,0.92)] px-3.5 py-2.5 text-left shadow-[inset_0_0_0_1px_rgba(255,255,255,0.13)] backdrop-blur-md transition hover:shadow-[inset_0_0_0_1px_rgba(var(--rgb-iris),0.4)] active:scale-[0.99]"
                  >
      ...
      <div className="pointer-events-auto flex items-center gap-2 rounded-pill border border-white/[0.14] bg-[rgba(22,22,31,0.9)] py-2 pl-4 pr-2 shadow-[0_14px_44px_-12px_rgba(0,0,0,0.7),0_0_26px_-12px_rgba(var(--rgb-iris),0.55)] backdrop-blur-xl">
        <Sparkles className="h-4 w-4 shrink-0 text-[color:rgb(var(--rgb-iris))]" />
        <input
          value={q}

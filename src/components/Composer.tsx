...
import { askSuggestions, followUps, type AskSuggestion } from "@/lib/askSuggestions";
                    ...
                    <div className="flex flex-col gap-1.5">
                      {weiter.map((s) => (
                        <button
                          key={s.q}
                          onClick={() => frage(s)}
                          className="rounded-[14px] px-3 py-2.5 text-left font-body text-[13px] leading-snug text-txt-2 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.10)] transition hover:text-txt hover:shadow-[inset_0_0_0_1px_rgba(120,150,255,0.34)]"
                        >
                          {s.q}
              ...
              <div className="flex flex-col gap-1.5 pb-1">
                {vorschlaege.map((s) => (
                  <button
                    key={s.q}
                    onClick={() => frage(s)}
                    className="rounded-[16px] bg-[rgba(22,22,31,0.92)] px-3.5 py-2.5 text-left shadow-[inset_0_0_0_1px_rgba(255,255,255,0.12)] backdrop-blur-md transition hover:shadow-[inset_0_0_0_1px_rgba(120,150,255,0.4)] active:scale-[0.99]"
                  >

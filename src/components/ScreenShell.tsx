...
export function ScreenShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <motion.main
      ...
      className="relative mx-auto min-h-full w-full max-w-[480px] px-[max(20px,5vw)] pb-[136px] pt-[calc(env(safe-area-inset-top,0px)+4rem)] lg:max-w-[880px] lg:px-12 lg:pb-24 lg:pt-12"
    >
      {children}
    </motion.main>
  );
